...
@SourceType(value = "AmazonAthenaARP", label = "AmazonAthena",uiConfig = "amazonathena-layout.json")
public class AmazonAthenaConf extends AbstractArpConf<AmazonAthenaConf> {
  private static final String ARP_FILENAME = "arp/implementation/amazonathena-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.amazonathena.AmazonAthenaDriver";
